...
This is the chance to let your skills shine! You have learned _sooo_ much the last month, and now you get to put all of your hard-earned skills to work. Choose an open api ([this list](https://api.funtranslations.com/translate/yoda.json)). Protip - don't take too long choosing an API. Pick one that looks interesting, and get building.
